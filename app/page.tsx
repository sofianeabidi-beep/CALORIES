    ...
    <main style={{ background: CREME, color: ENCRE }}>
      <section className="relative">
        ...
        <div className="px-6 pt-8 pb-10">
          ...
          <p className="mt-4 max-w-md text-base" style={{ color: BRUN_MUET }}>
      ...
      <section className="px-6 py-14">
        ...
        <h2
          className="mt-3 max-w-md text-2xl leading-[1.3] font-normal text-balance"
          style={{ fontFamily: SERIF }}
        >
      ...
      <section className="relative">
        ...
        <div className="px-6 py-10">
          ...
          <p className="mt-4 max-w-md text-base" style={{ color: BRUN_MUET }}>
            ...
            pour les ajuster. Pas de liste d’aliments interdits, pas de programme figé : juste
      ...
      <section className="px-6 pt-4 pb-16 text-center">
        <h2 className="text-2xl leading-[1.3] font-normal text-balance" style={{ fontFamily: SERIF }}>
          Prêt à commencer ?
        </h2>
